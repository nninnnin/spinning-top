...
!(function (n) {
        ...
        (l.prototype.defaultArg = function (t, e) {
          if (this.isObject(t) && this.isObject(e)) {
            var n,
              i,
              r = {};
            for (n in t) r[n] = this.defaultArg(e[n], t[n]);
            for (i in e) r[i] = this.defaultArg(t[i], e[i]);
            return r;
          }
        ...
        return (
          ...
          (u.TimelineSignal.prototype.exponentialRampToValueAtTime = function (
            ...
            (n = this._searchBefore(e)) &&
              ...
              (t = this._fromUnits(t));
            var n = Math.max(t, this._minOutput);
            return (
              this._events.add({
          ...
          (u.TimelineSignal.prototype.setRampPoint = function (t) {
            ...
            return (
              n && n.time === t
                ...
                : ((n = this._searchAfter(t)) &&
                    (this.cancelScheduledValues(t),
                    n.type === u.TimelineSignal.Type.Linear
                      ? this.linearRampToValueAtTime(e, t)
                      : n.type === u.TimelineSignal.Type.Exponential &&
          ...
          (u.TimelineSignal.prototype.getValueAtTime = function (t) {
            ...
            var e,
              n = this._searchAfter(t),
              i = this._searchBefore(t);
            return (
              this._initial,
              null === i
                ? this._initial
                : i.type === u.TimelineSignal.Type.Target
                ? ((e =
                    null === (e = this._events.getBefore(i.time))
                      ? this._initial
                      : e.value),
                  this._exponentialApproach(i.time, e, i.value, i.constant, t))
                : i.type === u.TimelineSignal.Type.Curve
                ? this._curveInterpolate(i.time, i.value, i.duration, t)
                : null === n
                ? i.value
                : n.type === u.TimelineSignal.Type.Linear
                ? this._linearInterpolate(i.time, i.value, n.time, n.value, t)
                : n.type === u.TimelineSignal.Type.Exponential
          ...
          (u.TimelineSignal.prototype._curveInterpolate = function (
            ...
            return t + n <= i
              ...
              : ((i = (i - t) / n),
                ...
                (r = e[t]),
                (e = e[n]),
                n === t ? r : this._linearInterpolate(t, r, n, e, i * (o - 1)));
          }),
        ...
        return (
          (i.Clock = function () {
            ...
            (this.callback = t.callback),
              (this._nextTick = 0),
              (this._lastState = i.State.Stopped),
              (this.frequency = new i.TimelineSignal(
                t.frequency,
                i.Type.Frequency
              )),
          ...
          (i.Clock.prototype.start = function (t, e) {
            return (
              ...
              this._state.getValueAtTime(t) !== i.State.Started &&
                this._state.add({ state: i.State.Started, time: t, offset: e }),
              this
            );
          }),
            ...
            for (
              ...
              var e = this._state.getValueAtTime(this._nextTick),
                n =
                  (e !== this._lastState &&
                    ((this._lastState = e),
                    (n = this._state.get(this._nextTick)),
                    e === i.State.Started
                      ...
                      : e === i.State.Paused && this.emit("pause", n.time)),
                  this._nextTick);
              this.frequency &&
                ((this._nextTick +=
                  1 / this.frequency.getValueAtTime(this._nextTick)),
                e === i.State.Started) &&
                (this.callback(n), this.ticks++);
            }
          }),
      ...
      (e = function (i) {
        return (
          ...
          (i.Context.prototype._createWorker = function () {
            ...
            return (
              (t = new Worker(t)).addEventListener(
                "message",
                function () {
                  this.emit("tick");
                }.bind(this)
      ...
      (e = function (n) {
        return (
          ...
          (n.Time.prototype.toNotation = function () {
            ...
            return (t = this._toNotationHelper(t, [
              "1m",
              "2n",
              "2t",
              "4n",
          ...
          (n.Time.prototype.toBarsBeatsSixteenths = function () {
            var t = this._beatsToUnits(1),
              e = ((t = this.toSeconds() / t) % 1) * 4;
            return [
              Math.floor(t / this._timeSignature()),
              Math.floor(t) % this._timeSignature(),
              (e =
                3 < (e = e.toString()).length ? parseFloat(e).toFixed(3) : e),
            ].join(":");
          }),
          (n.Time.prototype.toTicks = function () {
            var t = this._beatsToUnits(1),
              t = this.valueOf() / t;
            return Math.floor(t * n.Transport.PPQ);
          }),
      ...
      (e = function (i) {
        return (
          (i.TimeBase = function (t, e) {
            ...
            (this._expr = this._noOp),
              t instanceof i.TimeBase
                ? this.copy(t)
                : !this.isUndef(e) || this.isNumber(t)
                ? ((e = this.defaultArg(e, this._defaultUnits)),
                  (e = this._primaryExpressions[e].method),
                  (this._expr = e.bind(this, t)))
                : this.isString(t)
                ? this.set(t)
          ...
          (i.TimeBase.prototype._matchGroup = function (t, e, n) {
            if (!this.isUndef(t))
              for (var i in e)
                if ((i = e[i]).regexp.test(t.value)) {
                  if (this.isUndef(n)) return i;
                  if (i.precedence === n) return i;
                }
            return !1;
          }),
          ...
          (i.TimeBase.prototype._parseUnary = function (t) {
            var e,
              n = t.peek();
            return (n = this._matchGroup(n, this._unaryExpressions))
              ? (t.next(), (e = this._parseUnary(t)), n.method.bind(this, e))
          ...
          (i.TimeBase.prototype._parsePrimary = function (t) {
            ...
            if (this._matchGroup(n, this._primaryExpressions))
              return (
                (e = (n = t.next()).value.match(n.regexp)),
                n.method.bind(this, e[1], e[2], e[3])
              );
            if (n && "(" === n.value) {
              if (
                (t.next(),
                (e = this._parseBinary(t)),
                (n = t.next()) && ")" === n.value)
              )
                return e;
            ...
            throw new SyntaxError(
              "Tone.TimeBase: Cannot process token " + n.value
            );
          }),
      ...
      (e = function (e) {
        ...
        return (
          ...
          (e.Timeline.prototype.add = function (t) {
            ...
            return (
              ...
              this.length > this.memory &&
                ((e = this.length - this.memory), this._timeline.splice(0, e)),
              this
            );
          }),
          (e.Timeline.prototype.remove = function (t) {
            return (
              this._iterating
                ...
                : -1 !== (t = this._timeline.indexOf(t)) &&
                  this._timeline.splice(t, 1),
              this
            );
          }),
          (e.Timeline.prototype.get = function (t) {
            return -1 !== (t = this._search(t)) ? this._timeline[t] : null;
          }),
          ...
          (e.Timeline.prototype.getAfter = function (t) {
            return (t = this._search(t)) + 1 < this._timeline.length
              ? this._timeline[t + 1]
              : null;
          }),
          (e.Timeline.prototype.getBefore = function (t) {
            var e = this._timeline.length;
            return (0 < e && this._timeline[e - 1].time < t) ||
              0 <= (e = this._search(t)) - 1
              ? this._timeline[e - 1]
              : null;
          }),
          ...
          (e.Timeline.prototype.cancelBefore = function (t) {
            return (
              this._timeline.length &&
                0 <= (t = this._search(t)) &&
                (this._timeline = this._timeline.slice(t + 1)),
              this
            );
          }),
          ...
          (e.Timeline.prototype.forEachBefore = function (t, e) {
            return -1 !== (t = this._search(t)) && this._iterate(e, 0, t), this;
          }),
          (e.Timeline.prototype.forEachAfter = function (t, e) {
            return (t = this._search(t)), this._iterate(e, t + 1), this;
          }),
          ...
          function o(e, n) {
            (i(e)
              ...
              : function t() {
                  i(e)
                    ? n()
                    : (requestAnimationFrame(t), e.resume && e.resume());
                })();
          }
          return (
            ...
            (s.prototype._ended = function (t) {
              var e, n;
              this._dragged ||
                ((e = (t = t).createBuffer(1, 1, t.sampleRate)),
                ((n = t.createBufferSource()).buffer = e),
                ...
                (function t(e, n, i) {
                  ...
                  if (Array.isArray(e) || (NodeList && e instanceof NodeList))
                    ...
                    "string" == typeof e
                      ...
                      : e.jquery && "function" == typeof e.toArray
                      ? t(e.toArray(), n, i)
                      : Element &&
                        e instanceof Element &&
                        ((r = new s(e, i)), n.push(r));
  ...
  function (t, e) {
      ...
      var i = this,
        ...
        e =
          (this.parameters.forEach(function (t, e) {
            var n = s[++o] || (s[o] = new Float32Array(i.bufferSize));
    ...
    (s = []),
      "function" != typeof AudioWorkletNode &&
        ...
        (self.AudioWorklet =
          ((i.prototype.addModule = function (t, e) {
            var r = this;
            return fetch(t)
              .then(function (t) {
              ...
              .then(function (t) {
                var n = {
                  ...
                  i = new (function (t, e) {
                    var n, i;
                    ((r = document.createElement("iframe")).style.cssText =
                      "position:absolute;left:0;top:-999px;width:1px;height:1px;"),
                      e.appendChild(r);
                    var r = (e = r.contentWindow).document,
                      o = "var window,$hook";
                    for (n in e)
                      n in t || "eval" === n || ((o += ","), (o += n));
                    for (i in t)
    ...
    window,
      window.hasOwnProperty("webkitAudioContext") &&
        ...
        (AudioContext.prototype.createDelay = function (t) {
          t = t ? this.internal_createDelay(t) : this.internal_createDelay();
  ...
  function (t, e, n) {
    (n = [n(0), n(17)]),
      (e = function (n) {
        (n.Frequency = function (t, e) {
          if (!(this instanceof n.Frequency)) return new n.Frequency(t, e);
          n.TimeBase.call(this, t, e);
        }),
          n.extend(n.Frequency, n.TimeBase),
          (n.Frequency.prototype._primaryExpressions = Object.create(
            n.TimeBase.prototype._primaryExpressions
          )),
          (n.Frequency.prototype._primaryExpressions.midi = {
            regexp: /^(\d+(?:\.\d+)?midi)/,
            method: function (t) {
              return this.midiToFrequency(t);
            },
          }),
          (n.Frequency.prototype._primaryExpressions.note = {
            regexp: /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i,
            method: function (t, e) {
              return (
                (t = i[t.toLowerCase()] + 12 * (parseInt(e) + 1)),
                this.midiToFrequency(t)
              );
            },
          }),
          (n.Frequency.prototype._primaryExpressions.tr = {
            regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?/,
            method: function (t, e, n) {
              var i = 1;
              return (
          ...
          (n.Frequency.prototype.transpose = function (t) {
            return (
          ...
          (n.Frequency.prototype.harmonize = function (t) {
            return (
              (this._expr = function (t, e) {
          ...
          (n.Frequency.prototype.toMidi = function () {
            return this.frequencyToMidi(this.valueOf());
          }),
          (n.Frequency.prototype.toNote = function () {
            var t = this.valueOf(),
              t = Math.log(t / n.Frequency.A4) / Math.LN2,
              t = Math.round(12 * t) + 57,
              e = Math.floor(t / 12);
            return e < 0 && (t += -12 * e), r[t % 12] + e.toString();
          }),
          (n.Frequency.prototype.toSeconds = function () {
            return 1 / this.valueOf();
          }),
          (n.Frequency.prototype.toFrequency = function () {
            return this.valueOf();
          }),
          (n.Frequency.prototype.toTicks = function () {
            var t = this._beatsToUnits(1),
              t = this.valueOf() / t;
            return Math.floor(t * n.Transport.PPQ);
          }),
          (n.Frequency.prototype._frequencyToUnits = function (t) {
            return t;
          }),
          (n.Frequency.prototype._ticksToUnits = function (t) {
            return 1 / ((60 * t) / (n.Transport.bpm.value * n.Transport.PPQ));
          }),
          (n.Frequency.prototype._beatsToUnits = function (t) {
            return 1 / n.TimeBase.prototype._beatsToUnits.call(this, t);
          }),
          (n.Frequency.prototype._secondsToUnits = function (t) {
            return 1 / t;
          }),
          (n.Frequency.prototype._defaultUnits = "hz");
        var i = {
            cbb: -2,
            cb: -1,
            c: 0,
        ...
        return (
          (n.Frequency.A4 = 440),
          (n.Frequency.prototype.midiToFrequency = function (t) {
            return n.Frequency.A4 * Math.pow(2, (t - 69) / 12);
          }),
          (n.Frequency.prototype.frequencyToMidi = function (t) {
            return 69 + (12 * Math.log(t / n.Frequency.A4)) / Math.LN2;
          }),
          n.Frequency
        );
      }.apply(e, n));
  ...
  function (t, e, n) {
    (n = [n(0), n(16)]),
      (e = function (n) {
        return (
          (n.TransportTime = function (t, e) {
            if (!(this instanceof n.TransportTime))
              return new n.TransportTime(t, e);
            n.Time.call(this, t, e);
          }),
          n.extend(n.TransportTime, n.Time),
          (n.TransportTime.prototype._unaryExpressions = Object.create(
            n.Time.prototype._unaryExpressions
          )),
          (n.TransportTime.prototype._unaryExpressions.quantize = {
            regexp: /^@/,
            method: function (t) {
              var t = this._secondsToTicks(t()),
                e = Math.ceil(n.Transport.ticks / t);
              return this._ticksToUnits(e * t);
            },
          }),
          (n.TransportTime.prototype._secondsToTicks = function (t) {
            var e = this._beatsToUnits(1);
            return Math.round((t / e) * n.Transport.PPQ);
          }),
          (n.TransportTime.prototype.valueOf = function () {
            return (
              this._secondsToTicks(this._expr()) +
              (this._plusNow ? n.Transport.ticks : 0)
            );
          }),
          (n.TransportTime.prototype.toTicks = function () {
            return this.valueOf();
          }),
          (n.TransportTime.prototype.toSeconds = function () {
            return this._expr() + (this._plusNow ? n.Transport.seconds : 0);
          }),
          (n.TransportTime.prototype.toFrequency = function () {
            return 1 / this.toSeconds();
          }),
          n.TransportTime
        );
    ...
    (n = [
      ...
      (e = function (c) {
        ...
        function n(t, e, n) {
          return (
            (t = new t()),
            n._eval(e[0]).connect(t, 0, 0),
            n._eval(e[1]).connect(t, 0, 1),
            t
          );
        }
        function i(t, e, n) {
          return (t = new t()), n._eval(e[0]).connect(t, 0, 0), t;
        }
        function r(t) {
        ...
        return (
          ...
          c.extend(c.Expr, c.SignalBase),
          (c.Expr._Expressions = {
            value: {
              signal: {
                regexp: /^\d+\.\d+|^\d+/,
                method: function (t) {
                  return new c.Signal(r(t));
                },
              },
              input: {
                regexp: /^\$\d/,
            ...
            func: {
              abs: { regexp: /^abs/, method: i.bind(this, c.Abs) },
              mod: {
                regexp: /^mod/,
                method: function (t, e) {
                  var n = o(t[1]),
            ...
            binary: {
              ...
              "*": {
                regexp: /^\*/,
                precedence: 0,
                method: n.bind(this, c.Multiply),
              },
            },
            unary: {
              "-": { regexp: /^\-/, method: i.bind(this, c.Negate) },
              "!": { regexp: /^\!/, method: i.bind(this, c.NOT) },
            },
          }),
          (c.Expr.prototype._parseInputs = function (t) {
            var e = t.match(/\$\d/g),
              n = 0;
            if (null !== e)
              for (var i = 0; i < e.length; i++)
                var r = parseInt(e[i].substr(1)) + 1, n = Math.max(n, r);
            return n;
          }),
          (c.Expr.prototype._replacements = function (t) {
            for (var e = t.shift(), n = 0; n < t.length; n++)
              e = e.replace(/\%/i, t[n]);
            return e;
          }),
          (c.Expr.prototype._tokenize = function (t) {
            for (var e = -1, n = []; 0 < t.length; ) {
              var i = (function (t) {
                for (var e in c.Expr._Expressions) {
                  var n,
                    i = c.Expr._Expressions[e];
                  for (n in i) {
                    var r = i[n],
                      o = r.regexp;
                    if (null !== (o = t.match(o)))
                      return { type: e, value: o[0], method: r.method };
                  }
                }
          ...
          (c.Expr.prototype._parseTree = function (t) {
            var r = this._tokenize(t),
              o = this.isUndef.bind(this);
            function s(t, e) {
              return !o(t) && "glue" === t.type && t.value === e;
            }
            function a(t, e, n) {
              var i = c.Expr._Expressions[e];
              if (!o(t))
                for (var r in i)
                  if ((r = i[r]).regexp.test(t.value)) {
                    if (o(n)) return 1;
                    if (r.precedence === n) return 1;
                  }
            }
            function u(t) {
              for (
                      ...
                      ? (function t() {
                          ...
                          if (a(e, "unary"))
                            return (
                              (e = r.next()),
                              (n = t()),
                              { operator: e.value, method: e.method, args: [n] }
                            );
                          if (((e = r.peek()), o(e)))
                            throw new SyntaxError(
                          ...
                          if ("func" === e.type) {
                            ...
                            if (
                              ...
                              return { method: n.method, args: i, name: name };
                            throw new SyntaxError(
                              'Tone.Expr: Expected ) in a function call "' +
                                n.value +
                                '"'
                          ...
                          if ("value" === e.type)
                            return {
                              method: (e = r.next()).method,
                              args: e.value,
                            };
                          if (s(e, "(")) {
                            if ((r.next(), (i = u()), s((e = r.next()), ")")))
                              return i;
                            throw new SyntaxError("Expected )");
                          }
                          throw new SyntaxError(
          ...
          (c.Expr.prototype._eval = function (t) {
            if (!this.isUndef(t))
              return (t = t.method(t.args, this)), this._nodes.push(t), t;
          }),
          (c.Expr.prototype._disposeNodes = function () {
            for (var t = 0; t < this._nodes.length; t++) {
              var e = this._nodes[t];
              this.isFunction(e.dispose)
                ? e.dispose()
                : this.isFunction(e.disconnect) && e.disconnect(),
                (this._nodes[t] = e = null);
            }
            this._nodes = null;
          }),
          (c.Expr.prototype.dispose = function () {
            c.prototype.dispose.call(this), this._disposeNodes();
          }),
          c.Expr
        );
      }.apply(e, n));
      ...
      (e = function (e) {
        ...
        return (
          ...
          (e.TimelineState.prototype.getValueAtTime = function (t) {
            return null !== (t = this.get(t)) ? t.state : this._initial;
          }),
  ...
  function (V, t, e) {
        ...
        (p5.prototype.outputVolume = function (t) {
          ...
          if ("number" == typeof t) {
            ...
            o.output.gain.cancelScheduledValues(i + n),
              0 !== e && o.output.gain.linearRampToValueAtTime(r, i + n),
    ...
    function G(t) {
      ...
      var e = { A: 33, B: 35, C: 24, D: 26, E: 28, F: 29, G: 31 }[
        t[0].toUpperCase()
      ];
    ...
    function L(t) {
      for (
        var e = t.getChannelData(0),
          t = 1 < t.numberOfChannels ? t.getChannelData(1) : e,
          n = z(e, t),
          e = new window.ArrayBuffer(44 + 2 * n.length),
          i = new window.DataView(e),
          r =
            (a(i, 0, "RIFF"),
            i.setUint32(4, 36 + 2 * n.length, !0),
            a(i, 8, "WAVE"),
            a(i, 12, "fmt "),
            i.setUint32(16, 16, !0),
            i.setUint16(20, 1, !0),
            i.setUint16(22, 2, !0),
            i.setUint32(24, h.audiocontext.sampleRate, !0),
            i.setUint32(28, 4 * h.audiocontext.sampleRate, !0),
            i.setUint16(32, 4, !0),
            i.setUint16(34, 16, !0),
            a(i, 36, "data"),
            i.setUint32(40, 2 * n.length, !0),
            n.length),
          o = 44,
          s = 0;
        s < r;
    ...
    function W(t) {
      var e = new AudioWorkletNode(h.audiocontext, I.a.soundFileProcessor);
      return (
        e instanceof ScriptProcessorNode && (t = e.bufferSize),
        e.disconnect(),
        (e = null),
        t
      );
    ...
    var l = function (t, e, n) {
      ...
      Z = [e(27).default, e(28).default, e(29).default],
      X = h.audiocontext,
      Y = !1;
    p5.prototype.registerMethod("init", function () {
      ...
      Y ||
        ...
        (t = function () {
          (Y = !0), this._decrementPreload();
        }.bind(this)),
        Promise.all(
          Z.map(function (t) {
            (t = new Blob([t], { type: "application/javascript" })),
              (t = URL.createObjectURL(t));
            return X.audioWorklet.addModule(t).catch(function () {
    ...
    var u = (function () {
      function t() {
        if (!(this instanceof t))
          throw new TypeError("Cannot call a class as a function");
        (this.ac = h.audiocontext),
          (this.input = this.ac.createGain()),
          (this.output = this.ac.createGain()),
          (this._drywet = new H.a(1)),
          (this.wet = this.ac.createGain()),
          this.input.connect(this._drywet.a),
          this.wet.connect(this._drywet.b),
          this._drywet.connect(this.output),
          this.connect(),
          h.soundArray.push(this);
      }
      var e, n, i;
      return (
        (e = t),
        (n = [
          {
            ...
            value: function (t) {
              ...
              this.output.gain.cancelScheduledValues(n),
                this.output.gain.linearRampToValueAtTime(r, i + 0.001),
                this.output.gain.linearRampToValueAtTime(t, e);
            },
          },
          {
            key: "chain",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.output.connect(e.input || e),
                t && t._onNewInput && t._onNewInput(this);
            },
          },
          {
            key: "disconnect",
          ...
          },
          {
            key: "dispose",
            value: function () {
              var t = h.soundArray.indexOf(this);
              h.soundArray.splice(t, 1),
    ...
    var i = h.audiocontext,
      ot = (
        void 0 !== i.createStereoPanner
          ? function () {
              nt(n, u);
              var e = rt(n);
              function n() {
                ...
                return (
                  K(this, n),
                  ((t = e.call(this)).stereoPanner = t.ac.createStereoPanner()),
                  t.input.connect(t.stereoPanner),
                  t.stereoPanner.connect(t.wet),
                  t
                );
              }
              return (
                tt(n, [
                    ...
                    value: function (t, e) {
                      "number" == typeof t
                        ? this.stereoPanner.pan.linearRampToValueAtTime(
                            t,
                            this.ac.currentTime + (e || 0)
                          )
                        : void 0 !== t && t.connect(this.stereoPanner.pan);
                    },
                  },
                  {
                    key: "getPan",
                  ...
                  },
                  {
                    key: "dispose",
                    value: function () {
                      et(s(n.prototype), "dispose", this).call(this),
                        this.stereoPanner &&
          ...
          : function () {
              ...
              function n() {
                ...
                return (
                  K(this, n),
                  ((t = e.call(this)).input.channelCountMode = "explicit"),
                  (t.panValue = 0),
                  (t.left = i.createGain()),
                  (t.right = i.createGain()),
                  (t.left.channelInterpretation = "discrete"),
                  (t.right.channelInterpretation = "discrete"),
                  (t.splitter = i.createChannelSplitter(2)),
                  (t.merger = i.createChannelMerger(2)),
                  t.input.connect(t.splitter),
                  t.splitter.connect(t.left, 1),
                  t.splitter.connect(t.right, 0),
                  t.left.connect(t.merger, 0, 1),
                  t.right.connect(t.merger, 0, 0),
                  t.merger.connect(t.wet),
                  t
                );
              }
              return (
                tt(n, [
                  {
                    ...
                    value: function (t, e) {
                      this.panValue = t;
                      var e = i.currentTime + (e || 0),
                        t = (t + 1) / 2,
                        n = Math.cos((t * Math.PI) / 2),
                        t = Math.sin((t * Math.PI) / 2);
                      this.left.gain.linearRampToValueAtTime(t, e),
                        this.right.gain.linearRampToValueAtTime(n, e);
                    },
                  },
                  {
                    key: "getPan",
                  ...
                  },
                  {
                    ...
                    value: function () {
                      et(s(n.prototype), "dispose", this).call(this),
                        this.left && (this.left.disconnect(), delete this.left),
                        this.right &&
                          (this.right.disconnect(), delete this.right),
                        this.splitter &&
                          (this.splitter.disconnect(), delete this.splitter),
                        this.merger &&
                          (this.merger.disconnect(), delete this.merger);
                    },
                  },
                ]),
                n
    ...
    var f = h.audiocontext,
      ct = at(function t(e, n, i, r) {
        ut(this, t),
          (this.callback = e),
          (this.time = n),
          (this.id = i),
    ...
    var lt = (function () {
      function o(t, e, n, i) {
        ...
        (this._onended = function () {}),
          ...
          (this.buffer = null),
          (this.playbackRate = 1),
          (this.input = h.audiocontext.createGain()),
          (this.output = h.audiocontext.createGain()),
          (this.reversed = !1),
          (this.startTime = 0),
          (this.endTime = null),
          (this.pauseTime = 0),
          ...
          (this._clearOnEnd = function (t) {
            var t = t.target,
              e = this;
            (t._playing = !1),
              t.removeEventListener("ended", e._clearOnEnd),
              e._onended(e),
              e.bufferSourceNodes
                .map(function (t, e) {
                  return e;
                ...
                .reverse()
                .forEach(function (t) {
                  !1 === e.bufferSourceNodes[t]._playing &&
                    e.bufferSourceNodes.splice(t, 1);
                }),
              0 === e.bufferSourceNodes.length && (e._playing = !1);
          }.bind(this)),
        ...
        at(o, [
              ...
              void 0 !== this.url && "" !== this.url
                    ...
                    200 === r.status
                      ? o.panner &&
                        f.decodeAudioData(
                          r.response,
                          function (t) {
                            o.panner && ((o.buffer = t), n) && n(o);
                          },
                          function () {
                            var t, e;
                            o.panner &&
                              ((t = new l("decodeAudioData", s, o.url)),
                              (e =
                ...
                : void 0 !== this.file &&
                  (((t = new FileReader()).onload = function () {
                    o.panner &&
                      f.decodeAudioData(t.result, function (t) {
                        o.panner && ((o.buffer = t), n) && n(o);
                      });
                  }),
          ...
          },
          {
            ...
            value: function (t) {
              var e;
              t.lengthComputable
                ? ((e = (t.loaded / t.total) * 0.99), this._whileLoading(e, t))
              ...
              if (this.output) {
                ...
                if (
                  ...
                  (r =
                    ...
                    this._paused
                      ? (this.bufferSourceNode.start(t, this.pauseTime, r),
                        this._counterNode.start(t, this.pauseTime, r))
                      : (this.bufferSourceNode.start(t, o, r),
                        this._counterNode.start(t, o, r)),
                    (this._playing = !0),
                    (this._paused = !1),
                    ...
                    !0 === this._looping &&
                      ...
                      (this.bufferSourceNode.loopEnd = e),
                      (this._counterNode.loopStart = o),
                      (this._counterNode.loopEnd = e));
                }
              }
            },
          },
          {
            ...
            value: function (t) {
              ...
              if ("restart" === t && this.buffer && this.bufferSourceNode)
                for (var e = 0; e < this.bufferSourceNodes.length; e++) {
                  var n = h.audiocontext.currentTime;
                  this.bufferSourceNodes[e].stop(n);
                }
              if ("restart" !== t && "sustain" !== t && "untildone" !== t)
          ...
          },
          {
            key: "pause",
            value: function (t) {
              t = (t || 0) + h.audiocontext.currentTime;
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                t = t || 0;
              "sustain" === this.mode || "untildone" === this.mode
                ? (this.stopAll(t),
                  (this._playing = !1),
                  (this.pauseTime = 0),
                  (this._paused = !1))
                : this.buffer &&
                  this.bufferSourceNode &&
                  ((e = h.audiocontext.currentTime),
                  (this.pauseTime = 0),
                  this.bufferSourceNode.stop(e + t),
                  this._counterNode.stop(e + t),
                  (this._playing = !1),
                  (this._paused = !1));
            },
          },
          {
            key: "stopAll",
            value: function (t) {
              var e = h.audiocontext.currentTime,
                n = t || 0;
              if (this.buffer && this.bufferSourceNode) {
                for (var i in this.bufferSourceNodes) {
                  i = this.bufferSourceNodes[i];
                  if (i)
                    try {
                      i.stop(e + n);
                    } catch (t) {}
              ...
              return (
                void 0 !== t &&
                  (0 === (this.playbackRate = t)
                    ...
                    : t < 0 && !this.reversed
                    ? ((t = Math.abs(t)), (n = !0))
                    : 0 < t && this.reversed && (n = !0),
                  this.bufferSourceNode &&
                    ((e = h.audiocontext.currentTime),
                    this.bufferSourceNode.playbackRate.cancelScheduledValues(e),
                    this.bufferSourceNode.playbackRate.linearRampToValueAtTime(
                      Math.abs(t),
                      e
                    ),
                    this._counterNode.playbackRate.cancelScheduledValues(e),
          ...
          },
          {
            ...
            value: function (t, e, n) {
              if ("number" == typeof t) {
                var e = e || 0,
                  n = n || 0,
                  i = h.audiocontext.currentTime,
                  r = this.output.gain.value;
                this.output.gain.cancelScheduledValues(i + n),
                  this.output.gain.linearRampToValueAtTime(r, i + n),
          ...
          },
          {
            ...
            value: function () {
              return this.reversed
                ? Math.abs(this._lastPos - this.buffer.length) / f.sampleRate
                : this._lastPos / f.sampleRate;
            },
          },
          {
            key: "jump",
            value: function (t, e) {
              ...
              this.isPlaying() &&
                (this.stop(0),
                this.play(0, this.playbackRate, this.output.gain.value, t, e));
            },
          },
          {
            key: "channels",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (((t = t || 5 * window.innerWidth), this.buffer)) {
                for (
                  var e = this.buffer,
                    n = e.length / t,
                    i = ~~(n / 10) || 1,
            ...
            value: function () {
              ...
              for (
                var t = this._lastPos / f.sampleRate,
                  e = this.getVolume(),
                  n = (this.setVolume(0, 0.001), this.buffer.numberOfChannels),
                  i = 0;
                i < n;
                i++
              )
          ...
          { key: "add", value: function () {} },
          {
            key: "dispose",
            value: function () {
              var t = h.audiocontext.currentTime,
                e = h.soundArray.indexOf(this);
              if (
                (h.soundArray.splice(e, 1),
                this.stop(t),
              ...
              this.output && (this.output.disconnect(), (this.output = null)),
                this.panner && (this.panner.dispose(), (this.panner = null));
            },
          },
          {
            key: "connect",
          ...
          { key: "getLevel", value: function () {} },
          {
            key: "setPath",
            value: function (t, e) {
              t = p5.prototype._checkFileFormats(t);
              (this.url = t), this.load(e);
            },
          },
          {
            key: "setBuffer",
            value: function (t) {
              var e = t.length,
                n = t[0].length,
                i = f.createBuffer(e, n, f.sampleRate);
            ...
            value: function () {
              ...
              return (
                ...
                (r.buffer = (function (t) {
                  for (
                    var e = t.length,
                      t = f.createBuffer(1, t.length, f.sampleRate),
                ...
                r.playbackRate.setValueAtTime(n.playbackRate, i),
                r.connect(n._workletNode),
                r
              );
            },
          },
    ...
    var ft = (function () {
      function e(t) {
        if (!(this instanceof e))
          throw new TypeError("Cannot call a class as a function");
        (this.bufferSize = W(2048)),
          (this.audiocontext = h.audiocontext),
          (this._workletNode = new AudioWorkletNode(
            this.audiocontext,
            I.a.amplitudeProcessor,
            {
          ...
          this.output.connect(this.audiocontext.destination),
          h.meter.connect(this._workletNode),
          h.soundArray.push(this);
      }
      var t, n, i;
      return (
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (t) {
              return void 0 !== t
                ? (this.normalize ? this.stereoVolNorm : this.stereoVol)[t]
                : this.normalize
                ? this.volNorm
                : this.volume;
            },
    ...
    var mt = (function () {
        function n(t, e) {
          if (!(this instanceof n))
            throw new TypeError("Cannot call a class as a function");
          (this.input = this.analyser = h.audiocontext.createAnalyser()),
            ...
            this.smooth(t),
            (this.bins = e || 1024),
            h.fftMeter.connect(this.analyser),
        ...
        return (
          ...
          (e = [
            ...
            },
            {
              key: "waveform",
              value: function () {
                for (var t, e = new Array(), n = 0; n < arguments.length; n++)
                  "number" == typeof arguments[n] && (this.bins = arguments[n]),
                    "string" == typeof arguments[n] && (t = arguments[n]);
                if (t && !p5.prototype._isSafari())
                  return (
                    (i = this).timeDomain,
                    i.timeDomain instanceof Float32Array == !1 &&
                      (i.timeDomain = new Float32Array(
                        i.analyser.frequencyBinCount
                      )),
                    this.analyser.getFloatTimeDomainData(this.timeDomain),
                    this.timeDomain
                  );
                (i = this).timeDomain,
                  i.timeDomain instanceof Uint8Array == !1 &&
                    (i.timeDomain = new Uint8Array(
                      i.analyser.frequencyBinCount
                    )),
                  this.analyser.getByteTimeDomainData(this.timeDomain);
                for (var i, r = 0; r < this.timeDomain.length; r++) {
            ...
            },
            {
              ...
              value: function () {
                ...
                return t && "db" === t.toLowerCase()
                  ? ((e = this).freqDomain instanceof Float32Array == !1 &&
                      (e.freqDomain = new Float32Array(
                        e.analyser.frequencyBinCount
                      )),
                    this.analyser.getFloatFrequencyData(this.freqDomain),
                    this.freqDomain)
                  : ((e = this).freqDomain,
                    e.freqDomain instanceof Uint8Array == !1 &&
                      (e.freqDomain = new Uint8Array(
                        e.analyser.frequencyBinCount
                      )),
            ...
            },
            {
              key: "getEnergy",
              value: function (t, e) {
                var n = h.audiocontext.sampleRate / 2;
                if (
                  ("bass" === t
                ...
                if ("number" != typeof e)
                  return (
                    (i = Math.round((t / n) * this.freqDomain.length)),
                    this.freqDomain[i]
                  );
                if (t < 0 || e < 0)
                ...
                e < t && ((i = e), (e = t), (t = i));
                for (
                  var i = Math.round((t / n) * this.freqDomain.length),
            ...
            },
            {
              ...
              value: function () {
                for (
                  var t = h.audiocontext.sampleRate / 2, e = 0, n = 0, i = 0;
                  i < this.freqDomain.length;
                  i++
                )
                  (e += i * this.freqDomain[i]), (n += this.freqDomain[i]);
                var r = 0;
                return (r = 0 !== n ? e / n : r) * (t / this.freqDomain.length);
              },
            },
            {
              key: "smooth",
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  var e = h.audiocontext.sampleRate / 2,
                    n = this.freqDomain,
                    i = n.length,
              ...
              value: function (t, e) {
                for (
                  var n = t || 3,
                    ...
                    i = [],
                    r = {
                      lo: t / Math.pow(2, 1 / (2 * n)),
                      ctr: t,
                      hi: t * Math.pow(2, 1 / (2 * n)),
                    },
                    o = (i.push(r), h.audiocontext.sampleRate / 2);
                  r.hi < o;

                ) {
                  var s = {};
                  (s.lo = r.hi),
                    (s.ctr = r.ctr * Math.pow(2, 1 / n)),
                    (s.hi = s.ctr * Math.pow(2, 1 / (2 * n))),
                    i.push(s),
                    (r = s);
                }
                return i;
    ...
    function Tt(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = St(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    function xt(t, e, n, i, r) {
      for (var o = null, s = null, a = null, u = 0; u < t.length; u++)
        if (t[u] instanceof n) {
          (o = 0 === u ? i : t[u - 1]),
            (s = u === t.length - 1 ? r : t[u + 1]),
            (a = t[u]),
            (t[u] = e);
          break;
        }
      null === a &&
        ((o = 0 === t.length ? i : t[t.length - 1]), (s = r), t.push(e)),
        o.disconnect(),
        null !== a && (a.disconnect(), a.dispose()),
        o.connect(e),
        e.connect(s);
    }
    var b = (function () {
        function i(t, e) {
          var n;
          m(this, i),
            "string" == typeof t && ((n = e), (e = t), (t = n)),
            "number" == typeof e && ((n = e), (e = t), (t = n)),
            (this.started = !1),
            (this.phaseAmount = void 0),
            (this.oscillator = h.audiocontext.createOscillator()),
            (this.f = t || 440),
            ...
            this.output.gain.setValueAtTime(0.5, h.audiocontext.currentTime),
            this.oscillator.connect(this.output),
            (this.connection = h.input),
            (this.panner = new ot()),
            this.output.connect(this.panner),
            (this.mathOps = []),
            h.soundArray.push(this),
          ...
          v(i, [
            {
              ...
              value: function (t, e) {
                if (
                  (this.started &&
                    ((i = h.audiocontext.currentTime), this.stop(i)),
                  !this.started)
                ) {
                  var n,
                    i = e || this.f,
                    e = this.oscillator.type;
                  for (n in (this.oscillator &&
                  ...
                  this._freqMods))
                    void 0 !== this._freqMods[n].connect &&
                      this._freqMods[n].connect(this.oscillator.frequency);
                  this.started = !0;
                }
              },
            },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if ("number" != typeof t || isNaN(t)) {
                  ...
                  (t = t.output ? t.output : t).connect(
                    this.oscillator.frequency
                  ),
                    this._freqMods.push(t);
                } else {
                  this.f = t;
                  var i = h.audiocontext.currentTime;
                  0 === e
            ...
            },
            {
              ...
              value: function () {
                this.output && this.output.disconnect(),
                  this.panner &&
                    (this.panner.disconnect(), this.output) &&
                    this.output.connect(this.panner),
                  (this.oscMods = []);
              },
            },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (this.phaseAmount = t),
                  this.dNode ||
                    ((this.dNode = h.audiocontext.createDelay()),
            ...
            },
            {
              ...
              value: function (t) {
                t = new bt.a(t);
                return (
                  xt(this.mathOps, t, bt.a, this.oscillator, this.output), this
                );
              },
            },
            {
              ...
              value: function (t) {
                t = new y.a(t);
                return (
                  xt(this.mathOps, t, y.a, this.oscillator, this.output), this
                );
              },
            },
            {
              ...
              value: function (t, e, n, i) {
                var r,
                  n =
                    4 === arguments.length
                      ? ((r = p5.prototype.map(0, t, e, n, i)),
                        p5.prototype.map(1, t, e, n, i))
                      : ((r = t), e),
                  i = new gt.a(r, n);
                return (
                  xt(this.mathOps, i, gt.a, this.oscillator, this.output), this
                );
              },
            },
          ]),
      ...
      vt = (function () {
        ...
        var e = Tt(n);
        function n(t) {
          return m(this, n), e.call(this, t, "sine");
        }
        return v(n);
      })(),
      kt = (function () {
      ...
      Ot = (function () {
        ...
        var e = Tt(n);
        function n(t) {
          return m(this, n), e.call(this, t, "sawtooth");
        }
        return v(n);
      })(),
      At = (function () {
        ...
        var e = Tt(n);
        function n(t) {
          return m(this, n), e.call(this, t, "square");
        }
        return v(n);
      })(),
      Ct = b,
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (this._rampAttackTC =
                this._rampAttackTime / this.checkExpInput(t)),
                (t = Math.log(1 / this._rampLowPercentage)),
                (this._rampDecayTC =
                  this._rampDecayTime / this.checkExpInput(t));
            },
          },
          {
            key: "setInput",
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              t && this.connection !== t && this.connect(t),
                this.triggerAttack(t, e),
                this.triggerRelease(t, e + this.aTime + this.dTime + ~~n);
            },
          },
          {
            key: "triggerAttack",
            value: function (t, e) {
              (e = h.audiocontext.currentTime + (e || 0)),
                (this.lastAttack = e),
                (this.wasTriggered = !0),
                t && this.connection !== t && this.connect(t),
                (t = this.control.getValueAtTime(e));
              !0 === this.isExponential
                ? this.control.exponentialRampToValueAtTime(
                    this.checkExpInput(t),
                    e
                  )
                : this.control.linearRampToValueAtTime(t, e),
                (e += this.aTime),
                !0 === this.isExponential
                  ? (this.control.exponentialRampToValueAtTime(
                    ...
                    (t = this.checkExpInput(this.control.getValueAtTime(e))),
                    this.control.cancelScheduledValues(e),
                    this.control.exponentialRampToValueAtTime(t, e))
                  : (this.control.linearRampToValueAtTime(this.aLevel, e),
                    (t = this.control.getValueAtTime(e)),
                    this.control.cancelScheduledValues(e),
                    this.control.linearRampToValueAtTime(t, e)),
                (e += this.dTime),
                !0 === this.isExponential
                  ? (this.control.exponentialRampToValueAtTime(
                    ...
                    this.control.cancelScheduledValues(e),
                    this.control.exponentialRampToValueAtTime(t, e))
                  : (this.control.linearRampToValueAtTime(this.dLevel, e),
                    (t = this.control.getValueAtTime(e)),
                    this.control.cancelScheduledValues(e),
                    this.control.linearRampToValueAtTime(t, e));
            },
              ...
              this.wasTriggered &&
                ...
                !0 === this.isExponential
                  ? (this.control.exponentialRampToValueAtTime(
                    ...
                    this.control.cancelScheduledValues(e),
                    this.control.exponentialRampToValueAtTime(t, e))
                  : (this.control.linearRampToValueAtTime(this.rLevel, e),
                    (t = this.control.getValueAtTime(e)),
                    this.control.cancelScheduledValues(e),
                    this.control.linearRampToValueAtTime(t, e)),
                (this.wasTriggered = !1));
          ...
          },
          {
            ...
            value: function (t, e, n, i) {
              (e = h.audiocontext.currentTime + (e || 0)),
                (n = this.checkExpInput(n)),
                (i = void 0 !== i ? this.checkExpInput(i) : void 0),
                t && this.connection !== t && this.connect(t),
                (t = this.checkExpInput(this.control.getValueAtTime(e)));
              t < n
                ? (this.control.setTargetAtTime(n, e, this._rampAttackTC),
                  (e += this._rampAttackTime))
                : n < t &&
                  (this.control.setTargetAtTime(n, e, this._rampDecayTC),
                  (e += this._rampDecayTime)),
                void 0 !== i &&
                  (n < i
                    ? this.control.setTargetAtTime(i, e, this._rampAttackTC)
                    : i < n &&
                      this.control.setTargetAtTime(i, e, this._rampDecayTC));
            },
          },
          {
            key: "connect",
            value: function (t) {
              (t =
                ...
                t instanceof p5.Delay
                  ? t.output.gain
                  : t) instanceof AudioParam &&
                t.setValueAtTime(0, h.audiocontext.currentTime),
          ...
          },
          {
            ...
            value: function (t) {
              var t = new bt.a(t),
                e = this.mathOps.length,
                n = this.output;
              return p5.prototype._mathChain(this, t, e, n, bt.a);
            },
          },
          {
            key: "mult",
            value: function (t) {
              var t = new y.a(t),
                e = this.mathOps.length,
                n = this.output;
              return p5.prototype._mathChain(this, t, e, n, y.a);
            },
          },
          {
            key: "scale",
            value: function (t, e, n, i) {
              (t = new gt.a(t, e, n, i)),
                (e = this.mathOps.length),
                (n = this.output);
              return p5.prototype._mathChain(this, t, e, n, gt.a);
            },
          },
          {
            key: "dispose",
    ...
    function Mt(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = Ft(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    var Dt = (function () {
        for (
          var t = 2 * h.audiocontext.sampleRate,
            e = h.audiocontext.createBuffer(1, t, h.audiocontext.sampleRate),
            n = e.getChannelData(0),
            i = 0;
          i < t;
          i++
      ...
      It = (function () {
        for (
          var t,
            e = 2 * h.audiocontext.sampleRate,
            n = h.audiocontext.createBuffer(1, e, h.audiocontext.sampleRate),
          ...
          var o = 2 * Math.random() - 1,
            s = 0.99886 * s + 0.0555179 * o,
            a = 0.99332 * a + 0.0750759 * o,
            u = 0.969 * u + 0.153852 * o,
            c = 0.8665 * c + 0.3104856 * o,
            l = 0.55 * l + 0.5329522 * o,
            p = -0.7616 * p - 0.016898 * o;
          (i[r] = s + a + u + c + l + p + t + 0.5362 * o),
            (i[r] *= 0.11),
            (t = 0.115926 * o);
        }
        return (n.type = "pink"), n;
      })(),
      Ut = (function () {
        for (
          var t = 2 * h.audiocontext.sampleRate,
      ...
      Rt = (function () {
        ...
        function r(t) {
          ...
          if (this instanceof r)
            return (
              delete (e = i.call(this)).f,
              delete e.freq,
              delete e.oscillator,
              (e.buffer = "brown" === t ? Ut : "pink" === t ? It : Dt),
              e
            );
          throw new TypeError("Cannot call a class as a function");
        }
            ...
            },
            {
              ...
              value: function () {
                this.started && this.stop(),
                  (this.noise = h.audiocontext.createBufferSource()),
    ...
    function Zt(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = Xt(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    function Yt() {
      for (
        ...
        n[i] = 1;
      t = t.createBufferSource();
      return (t.buffer = e), (t.loop = !0), t;
    }
    Gt = (function () {
      var t = r,
        e = Ct;
      ...
      function r(t, e) {
        ...
        if (!(this instanceof r))
          throw new TypeError("Cannot call a class as a function");
        ((n = i.call(this, t, "sawtooth")).w = e || 0),
          (n.osc2 = new Ot(t)),
          (n.dNode = h.audiocontext.createDelay()),
          (n.dcOffset = Yt()),
          (n.dcGain = h.audiocontext.createGain()),
          n.dcOffset.connect(n.dcGain),
          n.dcGain.connect(n.output),
          (n.f = t || 440);
        e = n.w / n.oscillator.frequency.value;
        return (
          (n.dNode.delayTime.value = e),
        ...
        (e = [
            ...
            value: function (t) {
              ...
              "number" == typeof t
                ? (t <= 1 &&
                    0 <= t &&
                    ((this.w = t),
                    (n = this.w / this.oscillator.frequency.value),
                ...
                : (t.connect(this.dNode.delayTime),
                  ...
                  (t = new y.a(-1)),
                  (e = new y.a(1.7)),
                  (n = n.connect(t).connect(e)).connect(this.dcGain.gain));
            },
          },
          {
            key: "start",
            value: function (t, e) {
              ...
              this.started ||
                ((t = t || this.f),
                (n = this.oscillator.type),
                (this.oscillator = h.audiocontext.createOscillator()),
                this.oscillator.frequency.setValueAtTime(t, i),
                (this.oscillator.type = n),
                this.oscillator.connect(this.output),
                this.oscillator.start(e + i),
                (this.osc2.oscillator = h.audiocontext.createOscillator()),
                this.osc2.oscillator.frequency.setValueAtTime(t, e + i),
                (this.osc2.oscillator.type = n),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.started &&
                ((e = h.audiocontext.currentTime),
                this.oscillator.stop((t = t || 0) + e),
                this.osc2.oscillator && this.osc2.oscillator.stop(t + e),
                this.dcOffset.stop(t + e),
                (this.started = !1),
                (this.osc2.started = !1));
            },
          },
          {
            ...
            value: function (t) {
              ...
              "number" == typeof t
                ? ((this.f = t),
                  (e = h.audiocontext.currentTime),
                  (n = this.oscillator.frequency.value),
                  this.oscillator.frequency.cancelScheduledValues(e),
                  this.oscillator.frequency.setValueAtTime(n, e + r),
                  this.oscillator.frequency.exponentialRampToValueAtTime(
                    t,
                    r + i + e
                  ),
                  this.osc2.oscillator.frequency.cancelScheduledValues(e),
                  this.osc2.oscillator.frequency.setValueAtTime(n, e + r),
        ...
        (n = [
          {
            ...
            value: function (e, n) {
              var i = this,
                t =
                  (this.stream && this.stop(), h.inputSources[i.currentSource]),
                r = {
                  audio: {
                    sampleRate: h.audiocontext.sampleRate,
                    echoCancellation: !1,
                  },
                };
              h.inputSources[this.currentSource] &&
                ...
                window.navigator.mediaDevices
                  ...
                  .then(function (t) {
                    (i.stream = t),
                      (i.enabled = !0),
                      (i.mediaStream =
                        h.audiocontext.createMediaStreamSource(t)),
          ...
          },
          {
            key: "getLevel",
            value: function (t) {
              return t && this.amplitude.smooth(t), this.amplitude.getLevel();
            },
          },
          {
            key: "amp",
            ...
            value: function (i, r) {
              return new Promise(function (e, n) {
                window.navigator.mediaDevices
                  .enumerateDevices()
                  .then(function (t) {
                    (h.inputSources = t.filter(function (t) {
          ...
          },
          {
            key: "setSource",
            value: function (t) {
              0 < h.inputSources.length &&
                t < h.inputSources.length &&
          ...
          },
          {
            ...
            value: function () {
              ...
              h.soundArray.splice(t, 1),
                this.stop(),
                this.output && this.output.disconnect(),
                this.amplitude && this.amplitude.dispose(),
    ...
    function re(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = T(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    var oe = (function () {
        ...
        function i(t) {
          ...
          return (
            Kt(this, i),
            ((e = n.call(this)).biquad = e.ac.createBiquadFilter()),
        ...
        return (
          te(i, [
            ...
            },
            {
              key: "dispose",
              value: function () {
                ee(T(i.prototype), "dispose", this).call(this),
      ...
      se = (function () {
        ...
        var t = re(e);
        function e() {
          return Kt(this, e), t.call(this, "lowpass");
        }
        return te(e);
      })(),
      ae = (function () {
        ...
        var t = re(e);
        function e() {
          return Kt(this, e), t.call(this, "highpass");
        }
        return te(e);
      })(),
      ue = (function () {
        ...
        var t = re(e);
        function e() {
          return Kt(this, e), t.call(this, "bandpass");
        }
        return te(e);
      })(),
      ce = oe;
    ...
    function he(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = fe(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    var ye = (function () {
      ...
      function r(t, e) {
        ...
        if (this instanceof r)
          return (
            (n = i.call(this, "peaking")).disconnect(),
            n.set(t, e),
      ...
      return (
        ...
        (e = [
          ...
          { key: "drywet", value: function () {} },
          {
            key: "connect",
            value: function (t) {
              t = t || p5.soundOut.input;
              (this.biquad || this.output).connect(t.input || t);
            },
          },
          {
            key: "disconnect",
          ...
          },
          {
            ...
            value: function () {
              var t = h.soundArray.indexOf(this);
              h.soundArray.splice(t, 1), this.disconnect(), delete this.biquad;
            },
          },
        ]) && le(t.prototype, e),
        n && le(t, n),
    ...
    function be(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = x(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
      ...
      function a(t) {
        ...
        for (var o = 0; o < t; o++)
          (r =
            ...
            (0 < o ? e.bands[o - 1] : e.input).connect(e.bands[o].biquad);
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function () {
              if (
                (me(x(a.prototype), "dispose", this).call(this), this.bands)
              ) {
    ...
    var Te = (function () {
      function e(t) {
        if (!(this instanceof e))
          throw new TypeError("Cannot call a class as a function");
        (this.ac = h.audiocontext), (this.listener = this.ac.listener);
      }
      var t, n, i;
      return (
        (t = e),
    ...
    var Oe = (function () {
      ...
      function r() {
        ...
        if (this instanceof r)
          return (
            ((t = i.call(this)).panner = t.ac.createPanner()),
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            key: "dispose",
            value: function () {
              Pe(O(r.prototype), "dispose", this).call(this),
    ...
    var Ee = (function () {
      ...
      function r() {
        ...
        if (this instanceof r)
          return (
            ((t = i.call(this))._split = t.ac.createChannelSplitter(2)),
            ...
            (t._leftFilter = new ce()),
            (t._rightFilter = new ce()),
        ...
        (e = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              t.connect(this.input),
                this.leftDelay.delayTime.setValueAtTime(e, this.ac.currentTime),
                this.rightDelay.delayTime.setValueAtTime(
                  e,
                  this.ac.currentTime
                ),
                (this._leftGain.gain.value = n),
                (this._rightGain.gain.value = n),
          ...
          },
          {
            key: "dispose",
            value: function () {
              Ce(C(r.prototype), "dispose", this).call(this),
                this._split.disconnect(),
    ...
    function De(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = j(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
        if (t && ("object" === R(t) || "function" == typeof t)) return t;
        if (void 0 !== t)
    ...
    var Ie = (function () {
        ...
        function n() {
          ...
          return (
            Ne(this, n),
            (t = e.call(this))._initConvolverNode(),
          ...
          Be(n, [
            ...
            },
            {
              ...
              value: function () {
                for (
                  var t,
                    e = this.ac.sampleRate,
                    n = e * this._seconds,
                    i = this._decay,
                    e = this.ac.createBuffer(2, n, e),
                    r = e.getChannelData(0),
                    o = e.getChannelData(1),
                    s = 0;
                  s < n;
                  s++
                )
                  (t = this._reverse ? n - s : s),
                    (r[s] = (2 * Math.random() - 1) * Math.pow(1 - t / n, i)),
                    (o[s] = (2 * Math.random() - 1) * Math.pow(1 - t / n, i));
                this._setBuffer(e);
              },
            },
            {
              key: "dispose",
              value: function () {
                Ve(j(n.prototype), "dispose", this).call(this),
                  this._teardownConvolverNode();
              },
            },
          ]),
      ...
      Ue = (function () {
        ...
        function o(t, e, n) {
          ...
          return (
            Ne(this, o),
            (i = r.call(this))._initConvolverNode(),
          ...
          Be(o, [
            {
              ...
              value: function (t, i, n) {
                ...
                u.open("GET", r, !0),
                  ...
                  (u.onload = function () {
                    ...
                    200 === u.status
                      ? a.decodeAudioData(
                          ...
                          function () {
                            var t = new l("decodeAudioData", s, o.url),
                              e =
                                "AudioContext error at decodeAudioData for " +
                                o.url;
                            n && ((t.msg = e), n(t));
                  ...
                  (u.onerror = function () {
                    var t = new l("loadConvolver", s, o.url),
                      e =
                        "There was no response from the server at " +
                        o.url +
                        ". Check the url and internet connectivity.";
            ...
            },
            {
              key: "dispose",
              value: function () {
                for (var t in (Ve(j(o.prototype), "dispose", this).call(this),
                this.impulses))
    ...
    var Ze = (function () {
      function t() {
        if (!(this instanceof t))
          throw new TypeError("Cannot call a class as a function");
        (this.clock = new Le.a({ callback: this.ontick.bind(this) })),
          (this.syncedParts = []),
          (this.bpm = 120),
          this._init(),
          (this.prevTick = 0),
        ...
        (n = [
          {
            ...
            value: function (t) {
              var i,
                e = t - this.prevTick,
                r = t - h.audiocontext.currentTime;
              e - this.tatumTime <= -0.02 ||
                ((this.prevTick = t),
                (i = this).syncedParts.forEach(function (t) {
                  t.isPlaying &&
                    (t.incrementStep(r),
                    t.phrases.forEach(function (t) {
                      var e = t.sequence,
                        n = i.metroTicks % e.length;
                      0 !== e[n] &&
                        (i.metroTicks < e.length || !t.looping) &&
                        t.callback(r, e[n]);
                    }));
                }),
                (this.metroTicks += 1),
          ...
          },
          {
            ...
            value: function (t) {
              var e = h.audiocontext.currentTime;
              this.clock.start(e + (t || 0)), this.setBPM(this.bpm);
            },
          },
          {
            key: "stop",
    ...
    var Qe = 120,
      Ke =
        ((p5.prototype.setBPM = function (t, e) {
          for (var n in ((Qe = t), h.parts))
            h.parts[n] && h.parts[n].setBPM(t, e);
        }),
        He(function t(e, n, i) {
          $e(this, t),
            (this.phraseStep = 0),
        ...
        return (
          He(n, [
            ...
            },
            {
              key: "pause",
              value: function (t) {
                (this.isPlaying = !1), this.metro.stop(t || 0);
              },
            },
            {
              key: "addPhrase",
              value: function (t, e, n) {
                var i;
                if (3 === arguments.length) i = new Ke(t, e, n);
                else {
                  if (!(t instanceof Ke))
      ...
      Ge = (function () {
        function t() {
          $e(this, t), (this.parts = []), (this.currentPart = 0);
          var e,
            n = this;
          for (e in arguments)
            (this.parts[e] = arguments[e]),
              0 < e && (this.parts[e - 1].nextPart = this.parts[e]),
        ...
        (e = [
          {
            ...
            value: function (t) {
              var e = h.audiocontext.currentTime;
              this.isPlaying ||
                (this.clock.start(e + (t || 0)), (this.isPlaying = !0));
            },
          },
          {
            key: "stop",
            value: function (t) {
              var e = h.audiocontext.currentTime;
              this.isPlaying &&
                (this.clock.stop(e + (t || 0)), (this.isPlaying = !1));
            },
          },
          {
            key: "pause",
            value: function (t) {
              var e = h.audiocontext.currentTime;
              this.isPlaying &&
                (this.clock.pause(e + (t || 0)), (this.isPlaying = !1));
            },
          },
          {
            key: "syncedStart",
            value: function (t, e) {
              ...
              t.isPlaying
                ? t.isPlaying &&
                  ((n = t.clock._nextTick - h.audiocontext.currentTime),
                  this.clock.start(i + n),
                  (this.isPlaying = !0))
                : (t.clock.start(i + e),
                  (t.isPlaying = !0),
                  this.clock.start(i + e),
                  (this.isPlaying = !0));
            },
          },
          {
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            key: "dispose",
            value: function () {
              rn(N(r.prototype), "dispose", this).call(this),
                this.compressor &&
        ...
        (e = [
          {
            key: "update",
            value: function (t) {
              t = this.energy = t.getEnergy(this.f1, this.f2) / 255;
              t > this.cutoff && t > this.threshold && 0 < t - this.penergy
                ? (this._onPeak(),
                  (this.isDetected = !0),
                  (this.cutoff = t * this.cutoffMult),
                  (this.framesSinceLastPeak = 0))
                : ((this.isDetected = !1),
    ...
    var fn = h.audiocontext,
      yn = (function () {
        function e() {
          if (!(this instanceof e))
            throw new TypeError("Cannot call a class as a function");
          (this.input = fn.createGain()),
            (this.output = fn.createGain()),
            (this._inputChannels = 2),
            (this._outputChannels = 2);
          var t = (this.bufferSize = W(1024));
          (this._workletNode = new AudioWorkletNode(fn, I.a.recorderProcessor, {
          ...
          (n = [
            {
              ...
              value: function (t) {
                this.input.disconnect(),
                  ...
                  (t || p5.soundOut.output).connect(this.input);
              },
            },
            {
              key: "record",
    ...
    var _n = (function () {
      ...
      function o(t, e) {
        ...
        if (!(this instanceof o))
          throw new TypeError("Cannot call a class as a function");
        if (
          ((n = r.call(this)), "number" != typeof (t = void 0 === t ? 0.25 : t))
        )
          throw new Error("amount must be a number");
        if ("string" != typeof (e = void 0 === e ? "2x" : e))
          throw new Error("oversample must be a String");
        var i = p5.prototype.map(t, 0, 1, 0, 2e3);
        return (
          (n.waveShaperNode = n.ac.createWaveShaper()),
          (n.amount = t),
          (n.waveShaperNode.curve = gn(i)),
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t, e) {
              var n;
              "number" == typeof t &&
                ((n = p5.prototype.map(t, 0, 1, 0, 2e3)),
                (this.amount = t),
                (this.waveShaperNode.curve = gn(n))),
          ...
          },
          {
            key: "dispose",
            value: function () {
              mn(B(o.prototype), "dispose", this).call(this),
                this.waveShaperNode &&
    ...
    function On(n) {
      ...
      return function () {
        var t,
          ...
          e =
            ((t = i
              ? ((t = An(this).constructor), Reflect.construct(e, arguments, t))
              : e.apply(this, arguments)),
            this);
    ...
    var Cn = (function () {
      ...
      function a(t, e, n, i, r, o) {
        if (this instanceof a) return s.call(this, t, e, n, i, r, o);
        throw new TypeError("Cannot call a class as a function");
      }
      return (
        (t = a),
    ...
    var En = (function () {
      ...
      return (
        ...
        (n = [
          ...
          { key: "setADSR", value: function (t, e, n, i) {} },
          {
            key: "connect",
            value: function (t) {
              var e = t || h.input;
    ...
    var In = (function () {
      ...
      function r() {
        ...
        if (this instanceof r)
          return (
            ((t = i.call(this)).oscillator = new Ct()),
            (t.env = new qt()),
            t.env.setRange(1, 0),
            t.env.setExp(!0),
            ...
            t.oscillator.start(),
            t.connect(),
            h.soundArray.push(Fn(t)),
            Object.defineProperties(Fn(t), {
              attack: {
                get: function () {
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t, e) {
              var n =
                ...
                t = G(t),
                e = e || 0.1;
              this.oscillator.freq(t, 0, n),
                this.env.ramp(this.output.gain, n, e);
            },
          },
          {
            key: "triggerRelease",
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                void 0 !== t && this.oscillator.amp(t, e || 0),
          ...
          },
          {
            key: "dispose",
            value: function () {
              Bn(Dn(r.prototype), "dispose", this).call(this),
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            key: "noteADSR",
            value: function (t, e, n, i, r) {
              var o = h.audiocontext.currentTime;
              this.audiovoices[
                this.notes[t].getValueAtTime(
                  o +
              ...
              var n,
                i =
                  2 < arguments.length && void 0 !== arguments[2]
                    ? arguments[2]
                    : 0,
                r = h.audiocontext.currentTime + i,
                t = G(t),
                e = e || 0.1,
                o =
                  (this.notes[t] &&
                    null !== this.notes[t].getValueAtTime(r) &&
                    this.noteRelease(t, 0),
                  this._voicesInUse.getValueAtTime(r) < this.maxVoices
                    ? (n = Math.max(~~this._voicesInUse.getValueAtTime(r), 0))
                    : ((n = this._oldest),
                      (o =
                  ...
                  (this.notes[t] = new jt.a()),
                  this.notes[t].setValueAtTime(n, r),
                  null === this._voicesInUse._searchBefore(r)
                    ? 0
                    : this._voicesInUse._searchBefore(r).value);
              this._voicesInUse.setValueAtTime(o + 1, r),
                this._updateAfter(r, 1),
                (this._newest = n),
                "number" == typeof e &&
                  (e =
                    (o = (1 / this._voicesInUse.getValueAtTime(r)) * 2) < e
                      ? o
                      : e),
                this.audiovoices[n].triggerAttack(t, e, i);
            },
          },
          {
            key: "_updateAfter",
            value: function (t, e) {
              null !== this._voicesInUse._searchAfter(t) &&
                ((this._voicesInUse._searchAfter(t).value += e),
                (t = this._voicesInUse._searchAfter(t).time),
                this._updateAfter(t, e));
            },
          },
          {
            key: "noteRelease",
            value: function (t, e) {
              ...
              if (t) {
                n = G(t);
                this.notes[n] &&
                  null !== this.notes[n].getValueAtTime(e) &&
                  ((t = Math.max(~~this._voicesInUse.getValueAtTime(e), 1)),
                  this._voicesInUse.setValueAtTime(t - 1, e),
                  0 < t && this._updateAfter(e, -1),
                  this.audiovoices[
                    this.notes[n].getValueAtTime(e)
                  ].triggerRelease(i),
                ...
                for (var r in (this.audiovoices.forEach(function (t) {
                  t.triggerRelease(i);
                }),
                this._voicesInUse.setValueAtTime(0, e),
                this.notes))
                  this.notes[r].dispose(), delete this.notes[r];
                (this._newest = 0), (this._oldest = 0);
              }
            },
          },
          {
    ...
    (p5.prototype.getAudioContext = c.b),
      ...
      (p5.prototype.sampleRate = function () {
        return h.audiocontext.sampleRate;
      }),
      (p5.prototype.freqToMidi = function (t) {
        return (t = Math.log(t / 440) / Math.log(2)), Math.round(12 * t) + 69;
      }),
      (p5.prototype.midiToFreq = n),
      (p5.prototype.noteToFreq = G),
      (p5.prototype.soundFormats = function () {
        ...
        for (var t = 0; t < arguments.length; t++) {
          ...
          h.extensions.push(arguments[t]);
        }
      }),
      (p5.prototype.disposeSound = function () {
        for (var t = h.soundArray.length - 1; 0 <= t; t--)
          h.soundArray[t].dispose();
      }),
      (p5.prototype._checkFileFormats = function (t) {
        if ("string" == typeof t) {
          ...
          if (-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n)) {
            if (!p5.prototype.isFileSupported(n))
              for (
                ...
                o < h.extensions.length;
                o++
              ) {
                var s = h.extensions[o];
            ...
            for (var u = 0; u < h.extensions.length; u++) {
              var c = h.extensions[u];
          ...
          for (var l = 0; l < t.length; l++) {
            var p = t[l].split(".").pop();
            if (p5.prototype.isFileSupported(p)) {
              e = t[l];
              break;
            }
          }
      ...
      (p5.prototype._mathChain = function (t, e, n, i, r) {
        for (var o in t.mathOps)
          t.mathOps[o] instanceof r &&
            (t.mathOps[o].dispose(), (n = o) < t.mathOps.length - 1) &&
            (i = t.mathOps[o + 1]);
        return (
      ...
      (p5.prototype.convertToWav = L),
      (p5.prototype.interleave = z),
      (p5.prototype.writeUTFBytes = a),
      (p5.prototype.safeBufferSize = W),
      (p5.prototype.saveSound = function (t, e) {
        (t = L(t.buffer)), p5.prototype.writeFile([t], e, "wav");
      }),
